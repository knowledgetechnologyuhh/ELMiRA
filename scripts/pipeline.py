...
def main():
    ...
    text_query = client.perform_asr(detect_start=detect_start, detect_stop=detect_stop, start_timeout=start_timeout,
                              min_duration=min_duration, max_duration=max_duration, min_period=min_period,
                              live_text=live_text, done_timeout=done_timeout)
